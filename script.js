  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        tatusImg.setAttribute('src', message.fail);
...
var modals = function modals() {
  ...
  function findModal(triggerSelector, modalSelector, closeSelector) {
  ...
  findModal('.button-design', '.popup-design', '.popup-design .popup-close');
  findModal('.button-consultation', '.popup-consultation', '.popup-consultation .popup-close');
  findModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true);
